...
public class Ex01_ArrayList {
	...
	public static void main(String[] args) {
		...
		// 마지막에 요소 추가
		list.add("서울");	 // add는 뒤에다가 추가함
		list.add("부산");
		list.add("인천");
		list.add("광주"); // 중복적인 요소 추가 가능
		list.add("서울");
		list.add("대전");
		...
		idx = list.indexOf("세종");
		System.out.println("세종 인덱스 : " + idx);	// 없으면 -1 반환
