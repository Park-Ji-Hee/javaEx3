...
public class Ex04 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Method m3 = cls.getDeclaredMethod("disp");	// 매개변수 없는 경우
			m3.invoke(b);
			// m3.invoke(b2);
...
class Book {
	public static String publisher = "이자바";
